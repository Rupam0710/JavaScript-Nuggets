...
const people = [
    {
        name : "rupam",
        location : {street : "137/2 , Purba Sinthee Road " , timezone:{offset :"+05:30"}}  
    },
    {
        name : "bob",
...
people.forEach((person)=>{
    console.log(person.location   && person.location.timezone && person.location.timezone.offset || "The offset is not defined");
})   
